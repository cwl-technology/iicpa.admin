            ...
            <div className="row">
              ...
              <div className='col-xl-8 col-12'>
                <div className="dashboad-main-card">
                  <h6 className='m-4 pt-4 dashboad-bold-font'>Live Sessions</h6>
                  <div className='row '>
                    <div className='col-4'>
              ...
              <div className="col-xl-4 col-12">
                <h6 className='m-4 pt-4 dashboad-bold-font'>Student Satisfaction</h6>
                <div className='px-4'>
                  <div className='d-flex align-items-end'>
                  ...
                  <table style={{ width: "100%" }}>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><p className='text-muted'>92%</p></td>
                      </tr>
                      <tr>
                        <td>
                          <div className='d-flex align-items-center'>
                      ...
                      <tr>
                        ...
                        <td><p className='text-muted'>2%</p></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              </div>
              <div className="col-12 top-courses-section p-4 mx-2">
                <div className='row'>
                  <div className='col-xl-4 col-12'>
                        ...
                        <div className="courses-two__single">
                          ...
                          <div className="courses-two__content">
                            ...
                            <h3 className="courses-two__title">
                              <a href="#">Getting Started with Computers and Beginner's Guide to Basic Skills</a></h3>
                      ...
                      <SwiperSlide>
                        <div className="courses-two__single">
                          ...
                          <div className="courses-two__content">
                            ...
                            <h3 className="courses-two__title">
                              <a href="#">Graphic Design Basics: Learn the Foundations of Visual</a></h3>
                            <div className="courses-two__btn-and-client-box">
                              <div className="courses-two__client-box">
                                <div className="courses-two__client-img">
                                  <img src="/assets/image/image.png" alt="" /></div>
