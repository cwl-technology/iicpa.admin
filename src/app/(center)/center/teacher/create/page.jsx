                        ...
                        <div className="card">
                            <div className="card-body">
                                <ul className="nav nav-tabs nav-bordered mb-3 d-flex justify-content-between">
                                    ...
                                    <li className="nav-item">
                                        <Link href="/center/teacher" className="btn center-btn-thm mb-2 me-2"> View Teacher</Link>
                                    </li>
                                </ul>
                                ...
                                <button className='mt-4 btn center-btn-thm' onClick={handleSubmit(onSubmit)} disabled={isSubmitting}>
