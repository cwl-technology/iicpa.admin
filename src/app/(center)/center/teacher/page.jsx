                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-xl-4">
                                                <div className="add-order text-xl-end mt-xl-0 mt-2">
                                                    ...
                                                    <Link href="/center/teacher/create" className="btn center-btn-thm mb-2 me-2"><i className="bi bi-plus-lg"></i> Add Teacher</Link>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <tr key={ind}>
                                                                        ...
                                                                        <td >
                                                                            <div className='d-flex align-items-center'>
                                                                                <Link href={{
                                                                                    pathname: "/center/teacher/edit",
                                                                                    query: { id: ele._id }
                                                                                }} className="btn center-btn-thm btn-sm ms-2"><i className="bi bi-pencil"></i></Link>
