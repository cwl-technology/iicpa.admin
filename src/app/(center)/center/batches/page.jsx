                                ...
                                <div className="box">
                                    <div className="box-body">
                                        <div className="radio-list">
                                            <div className="radio-inline p-0 me-10">
                                                <div className="radio radio-info">
                                                    <input type="radio" name="radio" id="radio1" value="option1" />
                                                    <label htmlFor="radio1">Online</label>

                                                </div>
                                                <div className="radio radio-info">
                                                    <input type="radio" name="radio" id="radio2" value="option2" />
                                                    <label htmlFor="radio2">Clashroom</label>
                                                </div>
                                            </div>
                                                ...
                                                <div className="add-live-sesssion text-xl-end mt-xl-0 mt-2">
                                                    {
                                                        ...
                                                        <Link href="/admin/batches BN/create" className="btn btn-primary mb-2 me-2"><i className="bi bi-plus-lg"></i> Add Batches</Link>
                                                    }
                                                </div>
                                            </div>
                                        </div>
