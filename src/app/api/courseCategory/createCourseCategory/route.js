...
export const POST = async (request) => {
    connectDB();
    try {
        const { categoryName, categorySlug, title, keywords, metaDescription } = await request.json();
        ...
        const data = new courseCategoryModel({ categoryName, categorySlug: formattedSlug, title, keywords, metaDescription });
        await data.save();
